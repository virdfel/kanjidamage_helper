...
Helps to find Kanji (meaning, components, onyomi, stroke order) from a Kanjidamage library.
...
#### B. How to use: Anki
#### Installation
- **1.** Add "Official KanjiDamage deck" (https://ankiweb.net/shared/info/748570187), it will download required images and JQuery library for a script work.
...
C. Customization
	1. File /source/script.js	
		1.1 Kanji sort by use frequency (by default) as "Official KanjiDamage deck REORDERED" 
